...
import com.expediagroup.openworld.sdk.rapid.models.ValueAdd1
...
@JsonProperty("value_adds")
    ...
    @field:Valid
    val valueAdds: kotlin.collections.Map<kotlin.String, ValueAdd1>? = null
) {
    ...
    class Builder(
        private var valueAdds: kotlin.collections.Map<kotlin.String, ValueAdd1>? = null
    ) {
        fun valueAdds(valueAdds: kotlin.collections.Map<kotlin.String, ValueAdd1>) = apply { this.valueAdds = valueAdds }

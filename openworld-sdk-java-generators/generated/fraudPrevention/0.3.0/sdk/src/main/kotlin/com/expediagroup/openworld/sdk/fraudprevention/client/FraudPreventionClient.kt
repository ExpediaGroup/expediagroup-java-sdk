...
* 
*/
open class FraudPreventionClient(clientConfiguration: ClientConfiguration = ClientConfiguration.EMPTY) : OpenApiStub(clientConfiguration) {
    ...
    private suspend inline fun kscreen(orderPurchaseScreenRequest: OrderPurchaseScreenRequest): OrderPurchaseScreenResponse {
    ...
    */
    @JvmOverloads
    fun screen(orderPurchaseScreenRequest: OrderPurchaseScreenRequest) : OrderPurchaseScreenResponse {
        try {
            return GlobalScope.future(Dispatchers.IO) {
                kscreen(orderPurchaseScreenRequest)
            }.get()
    ...
    private suspend inline fun kupdate(orderPurchaseUpdateRequest: OrderPurchaseUpdateRequest): Void? {
        val response = client.httpClient.request {
            method = HttpMethod.parse("POST")
    ...
    */
    @JvmOverloads
    fun update(orderPurchaseUpdateRequest: OrderPurchaseUpdateRequest) : Void? {
        try {
            return GlobalScope.future(Dispatchers.IO) {
                kupdate(orderPurchaseUpdateRequest)
            }.get()
        } catch (exception: Exception) {
            if (exception is OpenWorldException) throw exception

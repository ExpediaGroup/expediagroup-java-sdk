...
open class FraudPreventionClient : OpenApiStub {
    ...
    constructor(clientConfiguration: ClientConfiguration = ClientConfiguration.EMPTY) : super(clientConfiguration)
    ...
    class FraudPreventionClientBuilder internal constructor() {
        companion object {
            fun builder() = FraudPreventionClientBuilder()
        }

        fun defaultClient() = FraudPreventionClient()
        fun withConfiguration(clientConfiguration: ClientConfiguration) = FraudPreventionClient(clientConfiguration)
    }

 ...
 */
package com.expediagroup.sdk.exemplar.graphql.core.executor
 ...
 *
 * [AsyncRequestExecutor] extends [AbstractAsyncRequestExecutor] from the core package. To use it, you must override
 * the [executionPipeline] property to configure how requests and responses are processed.
 *
 * It's recommended to pass an optional [AsyncTransport] instance to the superclass constructor. This allows users
 ...
 *
 * The [AbstractAsyncRequestExecutor] takes care of resolving and wiring the transport as long as the appropriate
 * transport dependency is included in the classpath.
 *
 * @see AsyncTransport
 * @see AbstractAsyncRequestExecutor
 * @see ExecutionPipeline
 */
class AsyncRequestExecutor @JvmOverloads constructor(

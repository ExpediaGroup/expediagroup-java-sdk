...
@ConsistentCopyVisibility data class Booking private constructor(
    ...
    class Builder(
        ...
        fun confirmationNumber(confirmationNumber: kotlin.String) = apply {
        ...
        fun build(): Booking {
            ...
            val hotel = this.hotel.getOrThrow {
            ...
            val createdAt = this.createdAt.getOrThrow {
                IllegalArgumentException("createdAt must not be null")
            }

            val instance = Booking(

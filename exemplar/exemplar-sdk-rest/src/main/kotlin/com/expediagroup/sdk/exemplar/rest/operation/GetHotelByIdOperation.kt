...
import com.expediagroup.sdk.exemplar.rest.model.exception.GetHotelById400Exception
import com.expediagroup.sdk.exemplar.rest.model.exception.GetHotelById404Exception
 ...
 *
 * Executing the operation returns [com.expediagroup.sdk.rest.model.Response] of type [Hotel]
 *
 * The operation may result in the following exceptions:
 * - [GetHotelById400Exception]
 * - [GetHotelById404Exception]
 *
 * @property params [GetHotelByIdOperationParams]
 */
class GetHotelByIdOperation(
    private val params: GetHotelByIdOperationParams
) : OperationRequestTrait,
    UrlPathTrait,
    JacksonModelOperationResponseBodyTrait<Hotel> {
    override fun getOperationId(): String = "getHotelById"
    ...
    override fun getTypeIdentifier(): TypeReference<Hotel> = jacksonTypeRef()

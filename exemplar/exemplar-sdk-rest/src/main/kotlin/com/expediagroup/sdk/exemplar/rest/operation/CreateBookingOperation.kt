...
import com.expediagroup.sdk.exemplar.rest.model.exception.CreateBooking404Exception
 ...
 * - [CreateBooking400Exception]
 * - [CreateBooking404Exception]
 *
 * @property requestBody [BookingRequest]
 */
class CreateBookingOperation(
    private val requestBody: BookingRequest
) : OperationRequestTrait,
    UrlPathTrait,
    OperationRequestBodyTrait<BookingRequest>,
    JacksonModelOperationResponseBodyTrait<Booking>,
    ContentTypeTrait {
    override fun getOperationId(): String = "createBooking"
    ...
    override fun getRequestBody(): BookingRequest = requestBody

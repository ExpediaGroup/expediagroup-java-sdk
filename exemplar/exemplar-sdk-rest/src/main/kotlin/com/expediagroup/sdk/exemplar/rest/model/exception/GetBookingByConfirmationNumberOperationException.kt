 ...
 */
package com.expediagroup.sdk.exemplar.rest.model.exception
...
class GetBookingByConfirmationNumber400Exception(
    code: Int = 400,
...
class GetBookingByConfirmationNumber404Exception(
    code: Int = 404,
    val errorResponse: ProblemDetail?,
    requestId: UUID?,
    message: String?,

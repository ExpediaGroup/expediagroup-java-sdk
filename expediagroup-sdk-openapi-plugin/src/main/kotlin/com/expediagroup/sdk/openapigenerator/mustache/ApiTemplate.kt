...
/**
 * Represents an API template used in the OpenAPI generator.
 * Mapped internally to the OpenAPI generator's `TemplateDefinition` class.
 *
 ...
 * @property fileNameSuffix optional suffix that will be appended to the API file name.
 */

 ...
 */
data class LodgingRoomTypePriceRefundableDamageDeposit(
    ...
    class Builder(
        ...
        fun build(): LodgingRoomTypePriceRefundableDamageDeposit {
            return LodgingRoomTypePriceRefundableDamageDeposit(
                `value` = `value`,
                currency = currency
            )
        }

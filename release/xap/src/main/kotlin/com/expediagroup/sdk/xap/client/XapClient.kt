...
class XapClient private constructor(clientConfiguration: XapClientConfiguration) : BaseXapClient("xap", clientConfiguration) {
     ...
     * @throws ExpediaGroupApiCarErrorsException
     ...
     */
    fun execute(operation: GetCarDetailsOperation): Response<CarDetailsResponse> {
        return execute<Nothing, CarDetailsResponse>(operation)
    }
     ...
     */
    fun executeAsync(operation: GetCarDetailsOperation): CompletableFuture<Response<CarDetailsResponse>> {
        return executeAsync<Nothing, CarDetailsResponse>(operation)
    }
     ...
     */
    fun execute(operation: GetCarsListingsOperation): Response<CarListingsResponse> {
        return execute<Nothing, CarListingsResponse>(operation)
    }
     ...
     */
    fun executeAsync(operation: GetCarsListingsOperation): CompletableFuture<Response<CarListingsResponse>> {
        return executeAsync<Nothing, CarListingsResponse>(operation)
    }

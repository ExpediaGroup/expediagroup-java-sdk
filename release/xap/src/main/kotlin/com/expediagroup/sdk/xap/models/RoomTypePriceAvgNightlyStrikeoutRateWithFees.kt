 ...
 */
data class RoomTypePriceAvgNightlyStrikeoutRateWithFees(
    ...
    class Builder(
        ...
        fun build(): RoomTypePriceAvgNightlyStrikeoutRateWithFees {
            return RoomTypePriceAvgNightlyStrikeoutRateWithFees(
                `value` = `value`,
                currency = currency,

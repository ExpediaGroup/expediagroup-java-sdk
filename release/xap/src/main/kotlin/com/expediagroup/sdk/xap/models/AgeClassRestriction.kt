...
data class AgeClassRestriction(
    ...
    class Builder(
        ...
        private fun validateNullity() {
            if (ageClass == null) {
                throw NullPointerException("Required parameter ageClass is missing")
            }
            if (ageMinimum == null) {
                throw NullPointerException("Required parameter ageMinimum is missing")
            }
        }
    }

 ...
 */
data class LodgingRoomTypePricePropertyMandatoryFees(
    ...
    class Builder(
        ...
        fun build(): LodgingRoomTypePricePropertyMandatoryFees {
            return LodgingRoomTypePricePropertyMandatoryFees(
                `value` = `value`,
                currency = currency
            )
        }

...
data class CarMoney(
    ...
    @field:Valid
    val localCurrencyPrice: CarMoney? = null
) {
    companion object {
        @JvmStatic
        fun builder() = Builder()
    ...
    class Builder(
        ...
        private var localCurrencyPrice: CarMoney? = null
    ) {
        fun `value`(`value`: kotlin.String) = apply { this.`value` = `value` }

        fun currency(currency: kotlin.String) = apply { this.currency = currency }

        fun localCurrencyPrice(localCurrencyPrice: CarMoney?) = apply { this.localCurrencyPrice = localCurrencyPrice }

...
data class RatePlan(
    ...
    val paymentMethod: RatePlan.PaymentMethod,
    ...
    class Builder(
        ...
        private fun validateNullity() {
            if (roomTypeId == null) {
                throw NullPointerException("Required parameter roomTypeId is missing")
            }
            if (ratePlanId == null) {
                throw NullPointerException("Required parameter ratePlanId is missing")
            }
            if (inventorySourceId == null) {
                throw NullPointerException("Required parameter inventorySourceId is missing")
            }
            if (stayDates == null) {
                throw NullPointerException("Required parameter stayDates is missing")
            }
            if (remainingCount == null) {
                throw NullPointerException("Required parameter remainingCount is missing")
            }

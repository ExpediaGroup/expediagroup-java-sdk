 ...
 */
data class LodgingRoomTypePriceAvgNightlyRateWithFees(
    ...
    class Builder(
        ...
        fun build(): LodgingRoomTypePriceAvgNightlyRateWithFees {
            return LodgingRoomTypePriceAvgNightlyRateWithFees(
                `value` = `value`,
                currency = currency
            )
        }

...
import com.expediagroup.openworld.sdk.fraudprevention.models.BadGatewayError
import com.expediagroup.openworld.sdk.fraudprevention.models.BadRequestError
import com.expediagroup.openworld.sdk.fraudprevention.models.ForbiddenError
import com.expediagroup.openworld.sdk.fraudprevention.models.GatewayTimeoutError
import com.expediagroup.openworld.sdk.fraudprevention.models.InternalServerError
import com.expediagroup.openworld.sdk.fraudprevention.models.NotFoundError
...
import com.expediagroup.openworld.sdk.fraudprevention.models.OrderPurchaseUpdateResponse
import com.expediagroup.openworld.sdk.fraudprevention.models.ServiceUnavailableError
import com.expediagroup.openworld.sdk.fraudprevention.models.TooManyRequestsError
import com.expediagroup.openworld.sdk.fraudprevention.models.UnauthorizedError
 ...
 class FraudPreventionClient private constructor(clientConfiguration: OpenWorldClientConfiguration) : OpenWorldClient(clientConfiguration){
    ...
    private suspend inline fun kscreenWithResponse(orderPurchaseScreenRequest: OrderPurchaseScreenRequest, transactionId: UUID = UUID.randomUUID()): Response<OrderPurchaseScreenResponse> {
        val response = httpClient.request {
            ...
            url("fraud-prevention/v2/test/fraud-prevention/v2/order/purchase/screen")
    ...
    */
    ...
    private suspend inline fun kupdateWithResponse(orderPurchaseUpdateRequest: OrderPurchaseUpdateRequest, transactionId: UUID = UUID.randomUUID()): Response<OrderPurchaseUpdateResponse> {
        val response = httpClient.request {
            method = HttpMethod.parse("POST")
            url("fraud-prevention/v2/test/fraud-prevention/v2/order/purchase/update")
            appendHeaders(transactionId)
...
class Paginator<T>(
    private val client: FraudPreventionClient,
...
internal class ResponseStateFactory {
    companion object {
        fun <T> getState(link: String?, client: FraudPreventionClient, getBody: suspend (HttpResponse) -> T): ResponseState<T> {

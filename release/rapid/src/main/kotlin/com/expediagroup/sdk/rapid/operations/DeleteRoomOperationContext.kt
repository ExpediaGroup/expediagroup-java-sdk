 ...
 */
@JsonDeserialize(builder = DeleteRoomOperationParams.Builder::class)
data class DeleteRoomOperationContext(
    val customerIp: kotlin.String,
    val customerSessionId: kotlin.String? =
        null,
    val test: DeleteRoomOperationParams.Test? =
        null
) {
    companion object {
        @JvmStatic
    ...
    class Builder(
        ...
        fun build(): DeleteRoomOperationContext {
            validateNullity()

            return DeleteRoomOperationContext(

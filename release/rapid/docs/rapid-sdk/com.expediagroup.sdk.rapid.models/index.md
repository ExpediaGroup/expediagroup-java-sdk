//[rapid-sdk](../../index.md)/[com.expediagroup.sdk.rapid.models](index.md)
...
| Name | Summary |
|---|---|
| [Address](-address/index.md) | [JVM]<br>public final class [Address](-address/index.md)<br>Container for the property's address information. |
| [Address1](-address1/index.md) | [JVM]<br>public final class [Address1](-address1/index.md) |
| [Adjustment](-adjustment/index.md) | [JVM]<br>public final class [Adjustment](-adjustment/index.md)<br>Any price adjustments associated with this itinerary. |
| [AffiliateCollect](-affiliate-collect/index.md) | [JVM]<br>public final class [AffiliateCollect](-affiliate-collect/index.md)<br>This option will be returned if a booking can be made using Expedia Affiliate Collect. |
| [AllInclusive](-all-inclusive/index.md) | [JVM]<br>public final class [AllInclusive](-all-inclusive/index.md)<br>Information about the all-inclusive rate plans available at the property. |
| [Amenity](-amenity/index.md) | [JVM]<br>public final class [Amenity](-amenity/index.md)<br>An individual amenity. |
| [Amount](-amount/index.md) | [JVM]<br>public final class [Amount](-amount/index.md)<br>The monetary amount. |
| [Ancestors](-ancestors/index.md) | [JVM]<br>public final class [Ancestors](-ancestors/index.md)<br>A region ancestor. |
| [Area](-area/index.md) | [JVM]<br>public final class [Area](-area/index.md)<br>Information about the area of the room. |
| [AssociatedAirports](-associated-airports/index.md) | [JVM]<br>public final class [AssociatedAirports](-associated-airports/index.md)<br>Airports related to the property. |
| [Attribute](-attribute/index.md) | [JVM]<br>public final class [Attribute](-attribute/index.md)<br>An individual attribute. |
| [Attributes](-attributes/index.md) | [JVM]<br>public final class [Attributes](-attributes/index.md)<br>Attributes about the property. See our [attributes reference](https://developers.expediagroup.com/docs/rapid/lodging/content/content-reference-lists) for current known attribute ID and name values. |
| [BedGroup](-bed-group/index.md) | [JVM]<br>public final class [BedGroup](-bed-group/index.md)<br>An individual bed group. |
| [BedGroupAvailability](-bed-group-availability/index.md) | [JVM]<br>public final class [BedGroupAvailability](-bed-group-availability/index.md) |
| [BedGroupAvailabilityLinks](-bed-group-availability-links/index.md) | [JVM]<br>public final class [BedGroupAvailabilityLinks](-bed-group-availability-links/index.md)<br>A map of links, including links to confirm pricing and availability for the selected rate. |
| [BedGroupConfiguration](-bed-group-configuration/index.md) | [JVM]<br>public final class [BedGroupConfiguration](-bed-group-configuration/index.md)<br>An individual bed configuration. |
| [BillingContact](-billing-contact/index.md) | [JVM]<br>public final class [BillingContact](-billing-contact/index.md) |
| [BillingContactRequest](-billing-contact-request/index.md) | [JVM]<br>public final class [BillingContactRequest](-billing-contact-request/index.md) |
| [BillingContactRequestAddress](-billing-contact-request-address/index.md) | [JVM]<br>public final class [BillingContactRequestAddress](-billing-contact-request-address/index.md) |
| [BillingContactRequestWithPhone](-billing-contact-request-with-phone/index.md) | [JVM]<br>public final class [BillingContactRequestWithPhone](-billing-contact-request-with-phone/index.md) |
| [BoundingPolygon](-bounding-polygon/index.md) | [JVM]<br>public interface [BoundingPolygon](-bounding-polygon/index.md) |
| [Brand](-brand/index.md) | [JVM]<br>public final class [Brand](-brand/index.md)<br>An individual brand. |
| [BusinessModel](-business-model/index.md) | [JVM]<br>public final class [BusinessModel](-business-model/index.md)<br>How and when the payment can be taken. |
| [CancelPenalty](-cancel-penalty/index.md) | [JVM]<br>public final class [CancelPenalty](-cancel-penalty/index.md) |
| [CancelRefund](-cancel-refund/index.md) | [JVM]<br>public final class [CancelRefund](-cancel-refund/index.md)<br>The refund information for cancelling the itinerary. |
| [CardOption](-card-option/index.md) | [JVM]<br>public final class [CardOption](-card-option/index.md) |
| [CategoryAge](-category-age/index.md) | [JVM]<br>public final class [CategoryAge](-category-age/index.md)<br>An age category. |
| [CategoryProperty](-category-property/index.md) | [JVM]<br>public final class [CategoryProperty](-category-property/index.md)<br>The property's category. See our [property categories reference](https://developers.expediagroup.com/docs/rapid/lodging/content/content-reference-lists) for current known category ID and name values. |
| [CategoryValueAdd](-category-value-add/index.md) | [JVM]<br>public enum [CategoryValueAdd](-category-value-add/index.md) extends [Enum](https://docs.oracle.com/javase/8/docs/api/java/lang/Enum.html)&lt;[CategoryValueAdd](-category-value-add/index.md)&gt;<br>The general category that this value add promotion falls into. Values: FOOD_AND_BEVERAGE,ENTERTAINMENT,SERVICE,ACTIVITY,CREDIT |
| [Chain](-chain/index.md) | [JVM]<br>public final class [Chain](-chain/index.md)<br>An individual chain. |
| [ChangeRoomDetailsRequest](-change-room-details-request/index.md) | [JVM]<br>public final class [ChangeRoomDetailsRequest](-change-room-details-request/index.md) |
| [Charge](-charge/index.md) | [JVM]<br>public final class [Charge](-charge/index.md)<br>An object representing a charge. Information about the charge is provided in both the billable currency and the request currency. |
| [ChargeCalculated](-charge-calculated/index.md) | [JVM]<br>public final class [ChargeCalculated](-charge-calculated/index.md)<br>An object representing a charge. Information about the charge is provided in both the billable currency and the request currency. |
...
| [Image1](-image1/index.md) | [JVM]<br>public final class [Image1](-image1/index.md) |
...
| [Rate](-rate/index.md) | [JVM]<br>public final class [Rate](-rate/index.md)<br>A rate. |
...
| [TestNotificationRequest](-test-notification-request/index.md) | [JVM]<br>public final class [TestNotificationRequest](-test-notification-request/index.md) |

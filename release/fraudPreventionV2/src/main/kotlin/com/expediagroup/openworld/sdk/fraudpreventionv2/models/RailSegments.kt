...
import com.expediagroup.openworld.sdk.fraudpreventionv2.models.RailSegmentsOperatingCompany
import com.expediagroup.openworld.sdk.fraudpreventionv2.models.RailwayStationDetails
...
/**
 * 
 * @param departureTime The local date and time of the scheduled departure from the departure station, in ISO-8061 date and time format `yyyy-MM-ddTHH:mm:ss.SSSZ`.
 * @param arrivalTime The local date and time of the scheduled arrival at the destination station, in ISO-8061 date and time format `yyyy-MM-ddTHH:mm:ss.SSSZ`.

...
@JsonProperty("message")
    ...
    class Builder(
        private var code: OrderPurchaseUpdateNotFoundError.Code? = null,
        private var message: kotlin.String? = null
    ) {
        fun code(code: OrderPurchaseUpdateNotFoundError.Code) = apply { this.code = code }
        fun message(message: kotlin.String) = apply { this.message = message }

        fun build(): OrderPurchaseUpdateNotFoundError {
            // Check required params
            validateNullity()
            return OrderPurchaseUpdateNotFoundError(
                code = code!!,
                message = message!!
            )
        }

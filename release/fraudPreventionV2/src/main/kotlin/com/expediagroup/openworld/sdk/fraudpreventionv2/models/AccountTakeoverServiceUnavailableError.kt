...
data class AccountTakeoverServiceUnavailableError(
    ...
    class Builder(
        private var code: AccountTakeoverServiceUnavailableError.Code? = null,
        private var message: kotlin.String? = null
    ) {
        fun code(code: AccountTakeoverServiceUnavailableError.Code) = apply { this.code = code }
        fun message(message: kotlin.String) = apply { this.message = message }

        fun build(): AccountTakeoverServiceUnavailableError {

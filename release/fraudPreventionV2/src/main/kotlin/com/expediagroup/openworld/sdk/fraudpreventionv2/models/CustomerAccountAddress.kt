 ...
 */
data class CustomerAccountAddress(
...
@field:Pattern(regexp = "^[A-Z]{3}$")
    ...
    val addressType: CustomerAccountAddress.AddressType? = null,
...
@JsonProperty("address_line2")
    ...
    class Builder(
        ...
        private var addressType: CustomerAccountAddress.AddressType? = null,

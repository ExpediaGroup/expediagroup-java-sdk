...
data class AccountTakeoverError(
    ...
    class Builder(
        private var code: AccountTakeoverError.Code? = null,
        private var message: kotlin.String? = null
    ) {
        fun code(code: AccountTakeoverError.Code) = apply { this.code = code }
        fun message(message: kotlin.String) = apply { this.message = message }

        fun build(): AccountTakeoverError {
            // Check required params
            validateNullity()
            return AccountTakeoverError(
                code = code!!,
                message = message!!
            )
        }

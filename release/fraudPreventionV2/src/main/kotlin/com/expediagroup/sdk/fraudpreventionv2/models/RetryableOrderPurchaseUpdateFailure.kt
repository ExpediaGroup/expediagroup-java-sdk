...
data class RetryableOrderPurchaseUpdateFailure(
    ...
    class Builder(
        private var code: RetryableOrderPurchaseUpdateFailure.Code? = null,
        private var message: kotlin.String? = null
    ) {
        fun code(code: RetryableOrderPurchaseUpdateFailure.Code) = apply { this.code = code }
        fun message(message: kotlin.String) = apply { this.message = message }

        fun build(): RetryableOrderPurchaseUpdateFailure {

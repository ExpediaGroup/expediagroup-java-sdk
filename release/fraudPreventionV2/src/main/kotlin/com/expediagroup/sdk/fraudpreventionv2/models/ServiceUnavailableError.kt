...
data class ServiceUnavailableError(
    ...
    @JsonProperty("code")
    val code: ServiceUnavailableError.Code,
    ...
    class Builder(
        private var code: ServiceUnavailableError.Code? = null,
        private var message: kotlin.String? = null
    ) {
        fun code(code: ServiceUnavailableError.Code) = apply { this.code = code }

        fun message(message: kotlin.String) = apply { this.message = message }

        fun build(): ServiceUnavailableError {

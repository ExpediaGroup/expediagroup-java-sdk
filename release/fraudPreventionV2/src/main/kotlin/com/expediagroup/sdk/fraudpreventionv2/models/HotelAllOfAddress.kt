...
data class HotelAllOfAddress(
    ...
    val addressType: HotelAllOfAddress.AddressType? = null,
    ...
    class Builder(
        ...
        private var addressType: HotelAllOfAddress.AddressType? = null,
        ...
        fun addressType(addressType: HotelAllOfAddress.AddressType) = apply { this.addressType = addressType }

        fun addressLine2(addressLine2: kotlin.String) = apply { this.addressLine2 = addressLine2 }

        fun build(): HotelAllOfAddress {
            // Check required params
            validateNullity()
            return HotelAllOfAddress(

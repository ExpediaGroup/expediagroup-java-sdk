...
function readRule (ruleName: string): NapiConfig {
    const rule = fs.readFileSync(`./rules/get-lodging-listings-operation-params/${ruleName}.yaml`, 'utf-8')
...
function addRoomsBuilderMethod(root: SgNode) : Edit[] {
    ...
    const source = fs.readFileSync('./resources/get-lodging-listings-operation-params/rooms.kt', 'utf-8')
...
export { process as processGetLodgingListingsOperationParams }

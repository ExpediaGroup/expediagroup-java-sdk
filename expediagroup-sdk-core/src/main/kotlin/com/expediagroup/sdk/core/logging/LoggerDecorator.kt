...
class LoggerDecorator(
    ...
    fun info(
        msg: String,
        vararg tags: String
    ) = logger.info(decorate(msg, tags.toSet()))

    fun warn(
        msg: String,
        vararg tags: String
    ) = logger.warn(decorate(msg, tags.toSet()))

    fun debug(
        msg: String,
        vararg tags: String
    ) = logger.debug(decorate(msg, tags.toSet()))

    fun error(
        msg: String,
        vararg tags: String
    ) = logger.error(decorate(msg, tags.toSet()))

    fun trace(
        msg: String,
        vararg tags: String
    ) = logger.trace(decorate(msg, tags.toSet()))

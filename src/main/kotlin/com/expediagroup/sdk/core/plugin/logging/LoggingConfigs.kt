...
data class LoggingConfigs(
    ...
    companion object : KtorPluginConfigsFactory<KtorPluginConfigs> {
        override fun from(httpClientConfig: HttpClientConfig<out HttpClientEngineConfig>) =
            LoggingConfigs(httpClientConfig)
    }
}

...
import com.expediagroup.openworld.sdk.core.config.provider.ConfigurationData
import com.expediagroup.openworld.sdk.core.constant.provider.ExceptionMessageProvider.getConfigurationUnknownMessage
...
class Config(
    ...
    operator fun get(key: String): Any {
        if (!configurations.containsKey(key)) {
            throw OpenWorldException(getConfigurationUnknownMessage(key))
        }

...
import com.expediagroup.openworld.sdk.core.constant.provider.LoggingMessageProvider.getResponseUnsuccessfulMessage
...
abstract class OpenApiStub(
    ...
    protected val client: com.expediagroup.openworld.sdk.core.client.Client by lazy { createClient() }
     ...
     */
    protected open fun createClient(): com.expediagroup.openworld.sdk.core.client.Client = com.expediagroup.openworld.sdk.core.client.Client.from(OkHttp.create(), clientConfiguration, false)

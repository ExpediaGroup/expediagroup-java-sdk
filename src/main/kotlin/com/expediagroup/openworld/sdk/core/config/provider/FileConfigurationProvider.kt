...
import com.expediagroup.openworld.sdk.core.constant.provider.ExceptionMessageProvider.getPropertyNotFoundMessage
...
class FileConfigurationProvider : ConfigurationProvider {
    ...
    override fun get(path: String, optional: Boolean): ConfigurationData {
        ...
        runCatching {
            ...
            if (!optional) {
                throw OpenWorldException(getPropertyNotFoundMessage(path))
            }
    ...
    override fun get(url: URL, optional: Boolean): ConfigurationData {
        return runCatching {
            ...
            if (!optional) throw OpenWorldException(getPropertyNotFoundMessage(url))

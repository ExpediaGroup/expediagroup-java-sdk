...
import com.expediagroup.openworld.sdk.core.constant.ConfigurationName
import com.expediagroup.openworld.sdk.core.constant.Constant
import com.expediagroup.openworld.sdk.core.constant.provider.ExceptionMessageProvider.getMissingRequiredConfigurationMessage
import com.expediagroup.openworld.sdk.core.constant.provider.LoggingMessageProvider
import com.expediagroup.openworld.sdk.core.contract.Contract
import com.expediagroup.openworld.sdk.core.contract.adhereTo
...
import com.expediagroup.openworld.sdk.core.plugin.authentication.AuthenticationHookFactory
import com.expediagroup.openworld.sdk.core.plugin.authentication.AuthenticationPlugin
...
import com.expediagroup.openworld.sdk.core.plugin.plugins
import com.expediagroup.openworld.sdk.core.plugin.request.DefaultRequestConfiguration
import com.expediagroup.openworld.sdk.core.plugin.request.DefaultRequestPlugin
import com.expediagroup.openworld.sdk.core.plugin.serialization.SerializationConfiguration
import com.expediagroup.openworld.sdk.core.plugin.serialization.SerializationPlugin
...
abstract class Client {
    ...
    private fun fireMissingConfigurationIssue(configurationKey: String): Nothing = throw OpenWorldConfigurationException(getMissingRequiredConfigurationMessage(configurationKey))

    /** Throw an exception if the authentication fails. */
    fun fireAuthIssue(message: String): Nothing = throw OpenWorldAuthException(message)
